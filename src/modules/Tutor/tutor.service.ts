...
//* Put tutor create availability slot
...
const getAvailability = async (tutorUserId: string) => {
    ...
    //* Get all Tutor availability slot by TutorId
...
//* Put mark as session finished
const markedSessionFinish = async (userId: string, bookingId: string,status:string) => {
